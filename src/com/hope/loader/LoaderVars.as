package com.hope.loader
{
	public class LoaderVars
	{
		...
		/**
		 * Constructor
		 * @param vars A generic Object containing properties that you'd like to add to this LoaderVars instance.
		 */
		public function LoaderVars(vars:Object=null) {
			_vars = {};
			if (vars != null) {
		...
		/** @private **/
		protected function _set(property:String, value:*):LoaderVars {
			if (value == null) {
		 ...
		 * @param value Value
		 */
		public function prop(property:String, value:*):LoaderVars {
		...
		public function autoDispose(value:Boolean):LoaderVars {
		...
		public function name(value:String):LoaderVars {
		...
		public function onCancel(value:Function):LoaderVars {
		...
		public function onComplete(value:Function):LoaderVars {
		...
		public function onError(value:Function):LoaderVars {
		...
		public function onFail(value:Function):LoaderVars {
		...
		public function onHTTPStatus(value:Function):LoaderVars {
		...
		public function onIOError(value:Function):LoaderVars {
		...
		public function onOpen(value:Function):LoaderVars {
		...
		public function onProgress(value:Function):LoaderVars {
...
//		public function requireWithRoot(value:DisplayObject):LoaderVars {
...
//		}
		...
		public function alternateURL(value:String):LoaderVars {
		...
		public function estimatedBytes(value:uint):LoaderVars {
		...
		public function noCache(value:Boolean):LoaderVars {
		...
		public function allowMalformedURL(value:Boolean):LoaderVars {
		...
		public function format(value:String):LoaderVars {
		...
		/** The generic Object populated by all of the method calls in the LoaderVars instance. This is the raw data that gets passed to the loader. **/
